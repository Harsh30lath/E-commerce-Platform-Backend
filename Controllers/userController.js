...
const register = asynchandler(async(req,res) =>{
    const {username,number,email,gender,password,confirmPassword,role} = req.body;

    if(!username || !number || !email || !password ||!confirmPassword || !gender || !role){
        res.status(400)
...
const profile = asynchandler(async(req,res) =>{
    ...
    .select('username email phone gender role')
